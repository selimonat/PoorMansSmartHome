...
class Home:
    ...
    def parse_device_log(self):
        ...
        d["time_hour"]           = epoch2hour(d.time_sec)
        return d

    def parse_ikea_log(self):
    
        d = pd.read_csv(self.file_ikea_log,delimiter=" ",usecols=list(range(0,24)) + [31])
...
def epoch2hour(epoch):
    """
    Converts linux epoch time to a hour bin
    """
